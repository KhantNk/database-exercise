...
if (count($_POST) > 0) {
	mysqli_query($conn, "UPDATE courses set course_id='" . $_POST['course_id']. "', first_name='" . $_POST['course_name'] . "', last_name='" . $_POST['description'] . "', city_name='" . $_POST['total_lessons'] . "' ,email='" . $_POST['start_date'] . "' WHERE userid='" . $_POST['userid'] . "'");
